...
//     // Prepend tractor make/model info to the top of the message if provided
//     const fullMessage = formData.productInterest
//       ? `Tractor Make/Model: ${formData.productInterest}\n\n${formData.message}`
//       : formData.message;
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-8">
          <h2 className="text-2xl font-heading font-bold text-neutral-800 mb-2">Our Location</h2>
          <p className="text-neutral-500 text-sm mb-6">
            SW7/217, Ibukun-Olu Street, Behind OBX Filling Station, Oke-Ado, Ibadan
          </p>
          <div className="w-full rounded-xl overflow-hidden" style={{ height: "450px" }}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.0!2d3.8964!3d7.3986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zN8KwMjMnNTUuMCJOIDPCsDUzJzQ3LjAiRQ!5e0!3m2!1sen!2sng!4v1700000000000!5m2!1sen!2sng&q=Ibukun-Olu+Street+Oke-Ado+Ibadan+Nigeria"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Office Location - Oke-Ado, Ibadan"
            />
          </div>
          <div className="mt-4 flex justify-end">
            <a
              href="https://maps.google.com/?q=Ibukun-Olu+Street,+Oke-Ado,+Ibadan,+Nigeria"
              target="_blank"
              rel="noopener noreferrer"
