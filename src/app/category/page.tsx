...
//                   )}
//                 >
//                   {Icon && <Icon className="w-4 h-4 flex-shrink-0" />} {cat.name}
//                 </button>
//               ))}
//             </div>
              ...
              {categories.map((cat) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => setSelectedCategory(cat.slug)}
                    className={cn(
                      "px-3 py-1.5 rounded-full text-sm whitespace-nowrap transition-colors inline-flex items-center gap-1.5",
                      selectedCategory === cat.slug
                        ? "bg-primary text-white"
                        : "bg-white border border-neutral-200 text-neutral-600"
                    )}
